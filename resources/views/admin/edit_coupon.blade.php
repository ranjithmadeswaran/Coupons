                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="select" id="product_type" name="product_type" data-placeholder="{{ __('select_product_type') }}">
                                        ...
                                        <div class="col-6" id="category_field" style="{{ ($data->product_type != 'all' && $data->product_type == 'category') ? '' : 'display: none'}}">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-6" id="subcategory_field" style="{{ ($data->product_type != 'all' && $data->product_type == 'subcategory') ? '' : 'display: none'}}">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-6" id="product_field" style="{{ ($data->product_type != 'all' && $data->product_type == 'service') ? '' : 'display: none'}}">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="select" id="coupon_type" name="coupon_type" data-placeholder="{{ __('select_coupon_type') }}">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="select " id="quantity" name="quantity" data-placeholder="{{ __('select_quantity') }}">
